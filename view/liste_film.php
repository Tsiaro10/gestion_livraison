   ...
   <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded text-warning" href="list_film_emprunter.php">film emprunter</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded text-warning" href="inscription.php">logout</a></li>
                    </ul>
                </div>
            </div>
        </nav></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <br>
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#deposer_<?php echo $film['ID_FILM'];?>">Emprunter</button><br><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
                 ...
                 <div class="modal-body">
                                    ...
                                    <form action="../controller/emprunt_control.php" method="POST">
                                                        <!-- Champs cachés pour les informations du livre -->
                                                        <input type="hidden" name="film_id" value="<?php echo $p["ID_FILM"]; ?>">
                                                        <input type="hidden" name="client_id" value="<?php echo $ide ?>">
                                                        <!-- Autres champs de réservation -->
                                                        <div class="form-group">
                                                            <label for="quantite_depot">DATE DE RETOUR :</label>
